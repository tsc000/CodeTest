...
- (void)showGuideInterfaceWith:(GuideInterfaceType)type {
    [self showGuideInterfaceWithType:type completion:NULL];
}

- (void)showGuideInterfaceWith:(GuideInterfaceType)type completion:(CompletionBlock)completion {
    [self showGuideInterfaceWithType:type completion:completion];
}
...
- (void)showGuideInterfaceWithType:(GuideInterfaceType)type completion:(CompletionBlock)completion {
    ...
    switch (type) {
        ...
        case GuideInterfaceTypeTwo:
            ...
            _guidePageKey = GuideInterfaceTwoKey;
            break;
...
- (void)showGuide {
    ...
    if (![[NSUserDefaults standardUserDefaults] boolForKey:@""]) {
        // 显示
        [[GuideInterface shareInstance] showGuideInterfaceWith:GuideInterfaceTypeOne completion:^{
            [[GuideInterface shareInstance] showGuideInterfaceWith:GuideInterfaceTypeTwo];
        }];
    }
}
@end
