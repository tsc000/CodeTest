//
//  LockCompareViewController.m
//  5、MultiThreadingProblem
//
//  Created by 童世超 on 2018/7/5.
...
@interface LockCompareViewController ()

@end

@implementation LockCompareViewController
...
- (IBAction)clearButtonDidClick:(UIButton *)sender {
...
- (IBAction)sumButtonDidClick:(UIButton *)sender {
